 ...
 * *****************************************************************************
 */
package com.hawk.funday.component.imageloader.utils;
...
public final class L {
    ...
    /**
     * 是否打开ImageLoader的log信息
     *
     * @param writeLog      所有运行log
     * @param writeDebugLog DebugLog
     */
    public static void setLogSwitch(boolean writeLog, boolean writeDebugLog) {
        writeDebugLogs = writeDebugLog;
        writeLogs = writeLog;
    }
     ...
     * {@link com.hawk.funday.component.imageloader.utils.L#disableLogging()} to disable ImageLoader
