...
import com.hawk.funday.component.imageloader.core.assist.ViewScaleType;
...
import com.hawk.funday.component.imageloader.core.imageaware.NonViewAware;
...
import com.hawk.funday.component.imageloader.core.listener.SimpleImageLoadingListener;
import com.hawk.funday.component.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
     ...
     * @param imageAware {@linkplain com.hawk.funday.component.imageloader.core.imageaware.ImageAware
     ...
     * @param imageAware {@linkplain com.hawk.funday.component.imageloader.core.imageaware.ImageAware
     *                   Image aware view} which should display image
     * @param options    {@linkplain com.hawk.funday.component.imageloader.core.DisplayImageOptions
     ...
     * @param listener         {@linkplain ImageLoadingListener Listener} for image loading process.
     *                         Listener fires events on UI thread if this method is called on UI thread.
     * @param progressListener {@linkplain com.hawk.funday.component.imageloader.core.listener.ImageLoadingProgressListener
     ...
     *                         {@linkplain com.hawk.funday.component.imageloader.core.DisplayImageOptions options} to
     *                         make this listener work.
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called
     *                                  before
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
    // 2015-07-15 addby wangdan 新增一个ImageSize，用来配合LscreenDecoder，解析图片前，只解析图片的上部分，满足笑料百科的需求
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
                             ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        ImageSize imageSize = null;
        if (imageAware instanceof NonViewAware) {
            imageSize = ((NonViewAware) imageAware).getImageSize();
        }

        displayImage(uri, imageAware, options, listener, progressListener, imageSize);
    }

    // add by wangdan, 2015-10-25
    // 添加一个直接显示bitmap的方法，如果不设置一下代码，图片会串掉
    public void displayImageFromBitmap(String uri, ImageAware imageAware, Bitmap bitmap, DisplayImageOptions options,
                                       ImageLoadingListener listener, ImageLoadingProgressListener progressListener, ImageSize customImageSize) {
        try {
            checkConfiguration();
        } catch (Exception e) {
            return;
        ...
        // 2015-07-15 addby wangdan 新增一个ImageSize，用来配合LscreenDecoder，解析图片前，只解析图片的一部分，满足笑料百科的需求
        ImageSize targetSize =
                customImageSize == null ? ImageSizeUtils.defineTargetSizeForView(imageAware,
                        configuration.getMaxImageSize()) : customImageSize;
        ...
        if (bitmap != null && !bitmap.isRecycled()) {
            ...
            if (options.shouldPostProcess()) {
                ImageLoadingInfo imageLoadingInfo =
                        new ImageLoadingInfo(uri, imageAware, targetSize, memoryCacheKey, options, listener,
                                progressListener, engine.getLockForUri(uri));
                ProcessAndDisplayImageTask displayTask =
                        new ProcessAndDisplayImageTask(engine, bitmap, imageLoadingInfo, defineHandler(options));
     ...
     * {@link com.hawk.funday.component.imageloader.core.imageaware.ImageAware ImageAware}
     */
     ...
     * {@link com.hawk.funday.component.imageloader.core.imageaware.ImageAware ImageAware}.
     *
     * @param imageAware {@link com.hawk.funday.component.imageloader.core.imageaware.ImageAware
     ...
     * {@linkplain com.hawk.funday.component.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
