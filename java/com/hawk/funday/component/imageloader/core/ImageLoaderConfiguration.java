 ...
 * *****************************************************************************
 */
package com.hawk.funday.component.imageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.hawk.funday.component.imageloader.cache.disc.DiskCache;
import com.hawk.funday.component.imageloader.cache.disc.naming.FileNameGenerator;
import com.hawk.funday.component.imageloader.cache.memory.MemoryCache;
import com.hawk.funday.component.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.hawk.funday.component.imageloader.core.assist.FlushedInputStream;
import com.hawk.funday.component.imageloader.core.assist.ImageSize;
import com.hawk.funday.component.imageloader.core.assist.QueueProcessingType;
import com.hawk.funday.component.imageloader.core.decode.ImageDecoder;
import com.hawk.funday.component.imageloader.core.download.ImageDownloader;
import com.hawk.funday.component.imageloader.core.process.BitmapProcessor;
import com.hawk.funday.component.imageloader.utils.L;
...
public final class ImageLoaderConfiguration {
     ...
     * <li>diskCache = {@link com.hawk.funday.component.imageloader.cache.disc.impl.UnlimitedDiscCache}</li>
    ...
    public static class Builder {
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheExtraOptions(int, int, com.hawk.funday.component.imageloader.core.process.BitmapProcessor)}
         * instead
         */
        @Deprecated
         ...
         * {@link com.hawk.funday.component.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
         ...
         * Default value - {@link com.hawk.funday.component.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.hawk.funday.component.imageloader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
        ...
        /**
         * @deprecated Use {@link #diskCacheFileNameGenerator(com.hawk.funday.component.imageloader.cache.disc.naming.FileNameGenerator)}
         */
        @Deprecated
         ...
         * Default value -
         * {@link com.hawk.funday.component.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
        ...
        /**
         * @deprecated Use {@link #diskCache(com.hawk.funday.component.imageloader.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.hawk.funday.component.imageloader.cache.disc.impl.UnlimitedDiscCache
         * BaseDiscCache}. Cache directory is defined by
         * {@link com.hawk.funday.component.imageloader.utils.StorageUtils#getCacheDirectory(Context)
         ...
         * Default value -
         * {@link com.hawk.funday.component.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
         ...
         * Default value -
         * {@link com.hawk.funday.component.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Consider {@link com.hawk.funday.component.imageloader.utils.L#disableLogging()} to disable
     ...
     * using {@link com.hawk.funday.component.imageloader.core.assist.FlushedInputStream}.
     *
     * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
     * @since 1.8.1
     */
