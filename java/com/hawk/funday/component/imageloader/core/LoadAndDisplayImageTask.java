...
import com.hawk.funday.component.imageloader.core.assist.FailReason.FailType;
...
import com.hawk.funday.component.imageloader.core.download.ImageDownloader.Scheme;
...
import com.hawk.funday.component.imageloader.utils.IoUtils;
 ...
 * display it in {@link com.hawk.funday.component.imageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
    ...
    private boolean downloadImage() throws IOException {
        Logger.v(String.format("request[type = image, url = %s]", uri.toString()));
